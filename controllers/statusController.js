...
const PERGUNTAS = [
  ...
  'Você prefere planejar tudo ou viajar sem roteiro?',
  'Qual é o seu fim de semana ideal?',
  'Um talento seu que poucas pessoas conhecem?',
  'Qual foi a melhor viagem que você já fez?',
  'Cachorro, gato, ou nenhum dos dois?',
  'Manhã ou noite - quando você rende mais?',
  'Qual hobby você queria ter mais tempo pra praticar?',
  'Uma comida que você nunca vai enjoar?',
  'Qual foi o show ou evento mais marcante que você foi?',
  'Se pudesse morar em outra cidade, qual seria?',
  'Qual conselho você daria pro seu eu de 18 anos?',
  'Time, esporte ou nenhum dos dois?',
  'O que mais te deixa animado essa semana?',
  'Netflix maratona ou livro bom?',
  'Churrasco ou comida japonesa?',
  'Academia ou trilha ao ar livre?',
  'Se pudesse ter um superpoder, qual seria?',
  'Qual é seu prazer culpado (série, comida, hábito)?',
  'Você é mais de planejar tudo ou ir na intuição?',
  ...
  'Qual conquista recente te deixou mais orgulhoso(a)?',
  'Doce ou salgado?',
  'Qual é o prato que você faz melhor?',
  'Café ou chá?',
  'Show ao vivo ou festival?',
  'Qual jogo (de tabuleiro, videogame, o que for) você mais gosta?',
  'O que mais valoriza numa amizade?',
  'Qual conselho você daria pra você mesmo(a) de 5 anos atrás?'
];
